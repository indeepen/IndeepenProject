...
public class Constants {
    ...
    public static final String DEFAULT_KEYWORD = "see";
    ...
    public static final String UPLOAD_PLAYLIST = "PLwUCQTtP4nd4eXmxuFBa4w8T3rnKiUZnK";
    public static final String APP_NAME = "Indeepen";
}
