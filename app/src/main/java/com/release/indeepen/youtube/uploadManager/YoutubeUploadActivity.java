...
public class YoutubeUploadActivity extends AppCompatActivity implements
    ...
    private void directTag(final VideoData video) {
        ...
        VideoSnippet snippet = video
                .addTags(Arrays.asList(
                        ...
                        Upload.generateKeywordFromPlaylistId(Constants.UPLOAD_PLAYLIST)*/)); //주석
            ...
            protected List<VideoData> doInBackground(Void... voids) {
                ...
                try {
                   ...
                   /* PlaylistListResponse plr = youtube.playlists().list("snippet ").setMine(true).execute();
                    ...
                    Utils.logAndShow(YoutubeUploadActivity.this, Constants.APP_NAME, e);
                }
                return null;
            }
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, YoutubeUploadActivity.this,
