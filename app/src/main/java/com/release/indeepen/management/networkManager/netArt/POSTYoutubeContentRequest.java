 ...
 */
public class POSTYoutubeContentRequest extends NetworkRequest<String> {
...
*/
    ...
    void setPost(HttpURLConnection conns){
        ...
        try {
            ...
            multipart.addFormField(DefineNetwork.POST_YOUTUBE, ((ContentYoutubeData) mData).sYouTubePath);
